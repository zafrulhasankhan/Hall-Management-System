            ...
            <div class="col-md-8 order-md-1">
                ...
                <form action="{{ url('/pay') }}" method="POST" class="needs-validation">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="address" placeholder="1234 Main St" value="93 B, New Eskaton Road" required>
                        <div class="invalid-feedback">
                    ...
                    <div class="custom-control custom-checkbox">
                        ...
                        <input   name="amount" id="total_amount" placeholder="amount" required /><br>
