            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.CreateInstuition') }}">
                        ...
                        <div class="row mb-3">
                            <label for="name" class="col-md-4 col-form-label text-md-end">{{ __('Instuition Name') }}</label>

                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control1 @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name">
